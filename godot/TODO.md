...
## Week 2 — Core Combat (no art needed)
 ...
 - [x] **2.1 Main.tscn** — Replace Boot.tscn
 ...
 - [x] **2.2 Player ship** — `scenes/Player.tscn` + `src/core/PlayerShip.gd`
 ...
 - [x] **2.3 Enemy base** — `scenes/Enemy.tscn` + `src/core/Enemy.gd`
 ...
 - [x] **2.4 Projectile pooling** — `scenes/Projectile.tscn` + `src/core/Projectile.gd`
 ...
 - [x] **2.5 Weapon firing** — `src/core/WeaponSystem.gd`
 ...
 - [x] **2.6 Sector spawner** — `src/core/Sector.gd`
 ...
 - [x] **2.7 Gems + Pods + Caches** — `scenes/Gem.tscn`, `Pod.tscn`, `Cache.tscn`
